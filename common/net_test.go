...
func TestDestinationKey(t *testing.T) {
	...
	assert.Equal(t, "10.10.10.10:443 (127.0.0.1:443)", NewDestinationKey(d, ad, "", Workload{}, Workload{}).String())

	assert.Equal(t,
		"aa.bb.s3.amazonaws.com:443 ()",
		NewDestinationKey(d, ad, "aa.bb.s3.amazonaws.com", Workload{}, Workload{}).String(),
	)

	assert.Equal(t,
		"amazonlinux-2-repos-us-east-1.s3.dualstack.us-east-1.amazonaws.com:443 ()",
		NewDestinationKey(d, ad, "amazonlinux-2-repos-us-east-1.s3.dualstack.us-east-1.amazonaws.com", Workload{}, Workload{}).String(),
	)

	assert.Equal(t,
		"bucket.s3.amazonaws.com:443 ()",
		NewDestinationKey(d, ad, "bucket.s3.amazonaws.com", Workload{}, Workload{}).String(),
	)

	assert.Equal(t,
		"bucket.s3-accelerate.amazonaws.com:443 ()",
		NewDestinationKey(d, ad, "bucket.s3-accelerate.amazonaws.com", Workload{}, Workload{}).String(),
	)

	assert.Equal(t,
		"bucket.s3.amazonaws.com.default.svc.cluster.local:443 ()",
		NewDestinationKey(d, ad, "bucket.s3.amazonaws.com.default.svc.cluster.local", Workload{}, Workload{}).String(),
	)
}
