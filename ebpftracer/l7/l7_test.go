...
func TestParseHost(t *testing.T) {
	requestString := "POST /api/v1/query?query=%28%0A++%28%0A++++kube_daemonset_status_current_number_scheduled%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A+++++%21%3D%0A++++kube_daemonset_status_desired_number_scheduled%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A++%29+or+%28%0A++++kube_daemonset_status_number_misscheduled%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A+++++%21%3D%0A++++0%0A++%29+or+%28%0A++++kube_daemonset_status_updated_number_scheduled%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A+++++%21%3D%0A++++kube_daemonset_status_desired_number_scheduled%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A++%29+or+%28%0A++++kube_daemonset_status_number_available%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A+++++%21%3D%0A++++kube_daemonset_status_desired_number_scheduled%7Bjob%3D%22kube-state-metrics%22%2C+namespace%3D~%22.%2A%22%7D%0A++%29%0A%29+and+%28%0A++changes%28kube_daemonset_status_updated_number_sched\x00798a"
